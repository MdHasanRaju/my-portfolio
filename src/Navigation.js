      ...
      <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
        <Container>
          ...
          <Navbar.Collapse id="responsive-navbar-nav">
            ...
            <Link style={{margin:"auto 5px", textDecoration:"none", color:"lightgray"}} to="/home">Home</Link>
            <Link style={{margin:"auto 5px", textDecoration:"none", color:"lightgray"}} to="/about">About</Link>
