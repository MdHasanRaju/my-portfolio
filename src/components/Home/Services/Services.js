      ...
      <div style={{ textAlign: "justify" }} className="heading mb-5">
        <Fade triggerOnce={true}>
          ...
          <p className="heading p__color">
            There are many services that i am able to provide. These are the specialty of me
          </p>
          <p className="heading p__color">
            and i am able to work according to your interest
          </p>
        </Fade>
      </div>
            ...
            <Slide triggerOnce={true}>
              <div className="service__box pointer">
                ...
                <div className="service__meta">
                  ...
                  <p className="p service__text p__color">
                    responsiveness can be implemented for all kinds of devices easily in a certain time.
                  </p>
                </div>
              </div>
            </Slide>
          ...
          <div className="col-lg-4 col-sm-6">
            <Zoom triggerOnce={true}>
              <div className="service__box pointer">
                ...
                <div className="service__meta">
                  <h1 className="service__text">Mobile-Optimized Website</h1>
                  <p className="p service__text p__color">
                    A mobile optimized site is a far more advanced website. I
